...
{ \
    ...
    \
    Neat_DString_Append_Allocator neat__unused = {0}; \
    (void) neat__unused; \
...
do \
{ \
    neat_str_clear(any_str_dst); \
    neat_str_print_append(any_str_dst __VA_OPT__(,) __VA_ARGS__); \
} while(0)
...
Neat_Error neat__fmutstr_ref_clear(Neat_Mut_String_Ref str);

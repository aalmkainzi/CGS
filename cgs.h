...
typedef struct CGS_ArrayFmt
{
    ...
    CGS_Error(* const elm_tostr)(CGS_Writer writer, const void *obj, const CGS_StrView fmt_opt);
...
static inline void *cgs__mutstr_ref_ctx(CGS_MutStrRef ref, CGS_Buffer *buffer_opt)
{
    switch(ref.ty)
    {
        case CGS__DSTR_TY:
        case CGS__STRBUF_TY:
            return ref.str.dstr; // both share the same pointer, so its fine
        case CGS__BUF_TY:
            *buffer_opt = ref.str.buf;
            return buffer_opt;
        default:
            return NULL;
    }
...
cgs__get_tostr_func(__typeof__(x))(cgs__as_writer, x, (CGS_StrView){0}); \
...
(CGS_Error(*)(CGS_Writer, const void*, const CGS_StrView))cgs__get_tostr_p_func(__typeof__(a)),

#define cgs_format_append(writer_dst, fmt, ...) \
    __VA_OPT__(cgs__format(cgs_writer(writer_dst), (CGS_StrView){.chars = (char*)(fmt ""), .len = sizeof(fmt) - 1}, 0 CGS__FOREACH(cgs__arg_count_each, __VA_ARGS__), (void*[]){CGS__FOREACH(cgs__as_ptr_elm, __VA_ARGS__)}, (CGS_Error(*[])(CGS_Writer,const void*, const CGS_StrView)){CGS__FOREACH(cgs__tostr_p_func_elm, __VA_ARGS__)})) \
...
#define cgs_format(mutstr_dst, fmt, ...) \
    __VA_OPT__(cgs__format(cgs_writer(cgs__clear_and_return(cgs_mutstr_ref(mutstr_dst))), (CGS_StrView){.chars = (char*)(fmt ""), .len = sizeof(fmt) - 1}, 0 CGS__FOREACH(cgs__arg_count_each, __VA_ARGS__), (void*[]){CGS__FOREACH(cgs__as_ptr_elm, __VA_ARGS__)}, (CGS_Error(*[])(CGS_Writer,const void*, const CGS_StrView)){CGS__FOREACH(cgs__tostr_p_func_elm, __VA_ARGS__)})) \
...
((CGS_ArrayFmt){ \
    ...
    .elm_tostr = (CGS_Error(*)(CGS_Writer,const void*,const CGS_StrView)) cgs__get_tostr_p_func(__typeof__((array_)[0])), \
    .open = cgs_strv("{"), \
    .close = cgs_strv("}"), \
    .separator = cgs_strv(", "), \
...
cgs__get_tostr_func(__typeof__(src))(cgs_writer(cgs__clear_and_return(cgs_mutstr_ref(dst))), (src), CGS__IF_EMPTY(cgs__null_strv()) __VA_OPT__(cgs_strv(__VA_ARGS__)) )

#define cgs_tostr_append(dst, src, ...) \
cgs__get_tostr_func(__typeof__(src))(cgs_writer(dst), (src), CGS__IF_EMPTY(cgs__null_strv()) __VA_OPT__(cgs_strv(__VA_ARGS__)))
...
cgs__invoke_tostr_len((CGS_Error(*)(CGS_Writer,const void*,const CGS_StrView)) cgs__get_tostr_p_func(__typeof__(src)), &(__typeof__(src)[]){src}[0], CGS__IF_EMPTY(cgs__null_strv()) __VA_OPT__(cgs_strv(__VA_ARGS__)))

#define cgs_tostr_p_len(srcp, ...) \
cgs__invoke_tostr_len((CGS_Error(*)(CGS_Writer,const void*,const CGS_StrView)) cgs__get_tostr_p_func(__typeof__(*(srcp))), (srcp), CGS__IF_EMPTY(cgs__null_strv()) __VA_OPT__(cgs_strv(__VA_ARGS__)))

#define CGS__DECL_TOSTR_FUNC(n) \
typedef __typeof__(CGS__MCALL(CGS__ARG1, ADD_TOSTR)) cgs__tostr_type_##n; \
static inline CGS_Error cgs__tostr_func_##n (CGS_Writer writer, cgs__tostr_type_##n obj, const CGS_StrView fmt_opt) \
{ \
    _Static_assert(cgs__has_type(CGS__MCALL(CGS__ARG2, ADD_TOSTR), __typeof__(CGS_Error(*)(CGS_Writer, cgs__tostr_type_##n, const CGS_StrView))), "tostr functions must have signature `CGS_Error(CGS_Writer writer, T src, const CGS_StrView fmt_opt)`"); \
    return CGS__MCALL(CGS__ARG2, ADD_TOSTR) (writer, obj, fmt_opt); \
} \
static inline CGS_Error cgs__tostr_p_func_##n (CGS_Writer writer, const cgs__tostr_type_##n *obj, const CGS_StrView fmt_opt) \
{ \
    return cgs__tostr_func_##n(writer, *obj, fmt_opt); \
}
...
CGS_API CGS_Error cgs__ullong_tostr(CGS_Writer writer, unsigned long long obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__float_tostr(CGS_Writer writer, float obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__double_tostr(CGS_Writer writer, double obj, const CGS_StrView fmt_opt);

CGS_API CGS_Error cgs__dstr_tostr(CGS_Writer writer, const CGS_DStr obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__dstr_ptr_tostr(CGS_Writer writer, const CGS_DStr *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strv_tostr(CGS_Writer writer, const CGS_StrView obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strbuf_tostr(CGS_Writer writer, const CGS_StrBuf obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strbuf_ptr_tostr(CGS_Writer writer, const CGS_StrBuf *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__mutstr_ref_tostr(CGS_Writer writer, const CGS_MutStrRef obj, const CGS_StrView fmt_opt);

CGS_API CGS_Error cgs__error_tostr(CGS_Writer writer, CGS_Error obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__array_fmt_tostr(CGS_Writer writer, CGS_ArrayFmt obj, const CGS_StrView fmt_opt);

CGS_API CGS_Error cgs__bool_tostr_p(CGS_Writer writer, const  bool *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__cstr_tostr_p(CGS_Writer writer, const char *const*obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__ucstr_tostr_p(CGS_Writer writer, const unsigned char *const*obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__char_tostr_p(CGS_Writer writer, const  char *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__schar_tostr_p(CGS_Writer writer, const  signed char *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__uchar_tostr_p(CGS_Writer writer, const  unsigned char *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__short_tostr_p(CGS_Writer writer, const  short *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__ushort_tostr_p(CGS_Writer writer, const  unsigned short *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__int_tostr_p(CGS_Writer writer, const  int *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__uint_tostr_p(CGS_Writer writer, const  unsigned int *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__long_tostr_p(CGS_Writer writer, const  long *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__ulong_tostr_p(CGS_Writer writer, const  unsigned long *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__llong_tostr_p(CGS_Writer writer, const  long long *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__ullong_tostr_p(CGS_Writer writer, const  unsigned long long *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__float_tostr_p(CGS_Writer writer, const  float *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__double_tostr_p(CGS_Writer writer, const  double *obj, const CGS_StrView fmt_opt);

CGS_API CGS_Error cgs__dstr_tostr_p(CGS_Writer writer, const CGS_DStr *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__dstr_ptr_tostr_p(CGS_Writer writer, const CGS_DStr *const*obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strv_tostr_p(CGS_Writer writer, const CGS_StrView *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strbuf_tostr_p(CGS_Writer writer, const CGS_StrBuf *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__strbuf_ptr_tostr_p(CGS_Writer writer, const CGS_StrBuf *const*obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__mutstr_ref_tostr_p(CGS_Writer writer, const CGS_MutStrRef *obj, const CGS_StrView fmt_opt);

CGS_API CGS_Error cgs__error_tostr_p(CGS_Writer writer, const CGS_Error *obj, const CGS_StrView fmt_opt);
CGS_API CGS_Error cgs__array_fmt_tostr_p(CGS_Writer writer, const CGS_ArrayFmt *obj, const CGS_StrView fmt_opt);

#define CGS__X(ty, extra) \
CGS_API CGS_Error cgs__Integer_d_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Integer_d_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Integer_x_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Integer_x_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Integer_o_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Integer_o_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Integer_b_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Integer_b_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Integer_X_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Integer_X_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
                                                                                                      \
                                                                                                      \
CGS_API CGS_Error cgs__Integer_d_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Integer_d_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Integer_x_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Integer_x_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Integer_o_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Integer_o_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Integer_b_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Integer_b_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Integer_X_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Integer_X_Fmt_##ty *obj, const CGS_StrView fmt_opt);
...
#define CGS__X(ty, extra) \
CGS_API CGS_Error cgs__Floating_f_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_f_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_g_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_g_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_e_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_e_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_a_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_a_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_F_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_F_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_G_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_G_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_E_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_E_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
CGS_API CGS_Error cgs__Floating_A_Fmt_##ty##_tostr(CGS_Writer writer, CGS__Floating_A_Fmt_##ty obj, const CGS_StrView fmt_opt);    \
                                                                                                        \
CGS_API CGS_Error cgs__Floating_f_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_f_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_g_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_g_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_e_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_e_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_a_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_a_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_F_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_F_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_G_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_G_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_E_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_E_Fmt_##ty *obj, const CGS_StrView fmt_opt); \
CGS_API CGS_Error cgs__Floating_A_Fmt_##ty##_tostr_p(CGS_Writer writer, CGS__Floating_A_Fmt_##ty *obj, const CGS_StrView fmt_opt);
